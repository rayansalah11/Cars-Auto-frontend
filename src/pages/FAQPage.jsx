      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at AUTOCARS@gmail.com with your order number and a brief
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                How do I contact customer support? You can contact our customer
                support team by emailing us at autocars@gmail.com, or by calling
                us at 00000000 between the hours of 9am and 5pm .
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Currently, we only offer shipping within the iraq.
              </p>
            </div>
          )}
        </div>
